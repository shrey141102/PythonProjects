...
while running:
    ...
    if c == 0:
        ...
        # Draw the button
        pygame.draw.rect(
            screen, black, (button_x, button_y, button_width, button_height)
        )
        ...
        text_rect = text_surface.get_rect(
            center=(
                yes_button_x + yes_button_width // 2,
                yes_button_y + yes_button_height // 2,
            )
        )
        screen.blit(text_surface, text_rect)
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            mouse_x, mouse_y = pygame.mouse.get_pos()
        if (
            yes_button_x <= mouse_x <= yes_button_x + yes_button_width
            and yes_button_y <= mouse_y <= yes_button_y + yes_button_height
        ):  # Placeholder action for button click
            c = c + 1
            sum = sum + 16
        ...
        # Draw the button
        pygame.draw.rect(
            screen, black, (no_button_x, no_button_y, no_button_width, no_button_height)
        )
        ...
        text_rect = text_surface.get_rect(
            center=(
                no_button_x + no_button_width // 2,
                no_button_y + no_button_height // 2,
            )
        )
        screen.blit(text_surface, text_rect)
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            mouse_x, mouse_y = pygame.mouse.get_pos()
        if (
            no_button_x <= mouse_x <= no_button_x + no_button_width
            and no_button_y <= mouse_y <= no_button_y + no_button_height
        ):  # Placeholder action for button click
            c = c + 1
        ...
        lastimg()
        text_lines = ["Your chosen number is ", f"{sum}", "Isn't it?", " ", "Thank you"]
